...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 2
    answer = count_cosines_from(3, 4, -2)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 0
    answer = count_cosines_from(3, 5, 2)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 1
    answer = count_cosines_from(3, 6, 0.5)
    ...
    # Test 6:
    expected = 3
    answer = count_cosines_from(3, 9, 0.2)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = (9/20)
    answer = sum_unit_fractions_from(4, 5)
